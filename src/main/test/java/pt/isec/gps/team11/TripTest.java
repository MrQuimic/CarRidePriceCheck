...
public class TripTest {
    ...
    void tripTest(){
        ...
        //book(boolean oneWay, String date, int extraWaitingTime, int numberOfLuggage, int numberOfPassengers, String departureTime, boolean highway)
        manager.book(true,"2022-12-28",0,3,3,"12:30",true);
        manager.saveTripResults("120|1:30|165");
        manager.confirmTrip();
    }
}
